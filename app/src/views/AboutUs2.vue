<template>
  <div>
    ...
    <div class="row photom">
      <img src="../assets/seol.jpg" class="Img" />
    </div>
    <div class="row marginT header">
      <div class="col-md-6">
        <h3 class="headerT">
          Aint no place made me feel like im home! except this , <br />
          <span class="spanT"> this makes me feel safe! </span>
        </h3>
      </div>
    </div>
    <div class="row marginT">
