<template>
  <div>
    ...
    <div class="row marginT header">
      <div class="col-md-6">
        <h3 class="headerT">
          To calm myself i go for walks,picnics and visiting nature.<br />
          <span class="spanT">
            It makes me feel at ease and my inner child safe!</span
          >
        </h3>
      </div>
    </div>
    <div class="row marginT">
      <div class="col-md-8 border height-800">
        <div
          class="col-md-6"
          style="float: left; margin-top: 10px; color: #808080"
        >
